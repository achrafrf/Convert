...
export default function WebpToJpg({ onClose }) {
  ...
  const convertToJpg = async () => {
    ...
    try {
      ...
      setConvertedFile({
        url: convertedUrl,
        name: selectedFile.name.replace('.webp', '.jpg'),
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">WEBP إلى JPG</h2>
              <p className="text-gray-600 text-sm">تحويل صور WEBP إلى formato JPG المتوافق</p>
            </div>
          </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              ...
              >
                {isConverting ? 'جاري التحويل...' : 'تحويل إلى JPG'}
              </button>
            </div>
              ...
              {convertedFile ? (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full border-2 border-gray-300 text-gray-700 py-2 px-4 rounded-2xl font-semibold hover:border-yellow-400 transition-colors"
                  >
                    تحويل صورة أخرى
                  </button>
                </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 text-sm">
                    {selectedFile ? 'انقر على تحويل لبدء العملية' : 'سيظهر ملف JPG المحول هنا'}
                  </p>
                </div>
              )}
            </div>
