...
export default function JfifToPng({ onClose }) {
  ...
  const convertToPng = async () => {
    ...
    try {
      ...
      setConvertedFile({
        url: convertedUrl,
        name: selectedFile.name.replace('.jfif', '.png'),
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">JFIF إلى PNG</h2>
              <p className="text-gray-600 text-sm">تحويل الصور من JFIF إلى PNG</p>
            </div>
          </div>
              ...
              {convertedFile ? (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full border-2 border-gray-300 text-gray-700 py-2 px-4 rounded-2xl font-semibold hover:border-green-400 transition-colors"
                  >
                    تحويل صورة أخرى
                  </button>
                </div>
