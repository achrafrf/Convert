...
export default function HeicToPng({ onClose }) {
  ...
  const convertToPng = async () => {
    ...
    try {
      ...
      setConvertedFile({
        url: convertedUrl,
        name: selectedFile.name.replace('.heic', '.png').replace('.HEIC', '.png'),
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">HEIC إلى PNG</h2>
              <p className="text-gray-600 text-sm">تحويل صور HEIC إلى PNG مع الحفاظ على الجودة</p>
            </div>
          </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              ...
              >
                {isConverting ? 'جاري التحويل...' : 'تحويل إلى PNG'}
              </button>
            </div>
              ...
              {convertedFile ? (
                <div className="space-y-4">
                  <div className="bg-white rounded-2xl p-4 text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-teal-100 to-green-100 rounded-2xl flex items-center justify-center mx-auto mb-3">
                  ...
                  <button
                    ...
                    className="w-full border-2 border-gray-300 text-gray-700 py-2 px-4 rounded-2xl font-semibold hover:border-teal-400 transition-colors"
                  >
                    تحويل صورة أخرى
                  </button>
                </div>
