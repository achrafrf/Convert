...
export default function WebpToPng({ onClose }) {
  ...
  const convertToPng = async () => {
    ...
    try {
      ...
      setConvertedFile({
        url: convertedUrl,
        name: selectedFile.name.replace('.webp', '.png'),
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">WEBP إلى PNG</h2>
              <p className="text-gray-600 text-sm">تحويل الصور من WEBP إلى PNG</p>
            </div>
          </div>
