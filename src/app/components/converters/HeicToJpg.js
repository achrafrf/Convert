...
export default function HeicToJpg({ onClose }) {
  ...
  const convertToJpg = async () => {
    ...
    try {
      ...
      setConvertedFile({
        url: convertedUrl,
        name: selectedFile.name.replace('.heic', '.jpg').replace('.HEIC', '.jpg'),
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">HEIC إلى JPG</h2>
              <p className="text-gray-600 text-sm">تحويل صور آيفون HEIC إلى JPG عالمي</p>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-yellow-50 rounded-2xl p-4">
                    <p className="text-yellow-700 text-sm text-center">
                      📱 تم تحويل صورة آيفون إلى formato JPG المتوافق مع جميع الأجهزة!
                    </p>
                  </div>
